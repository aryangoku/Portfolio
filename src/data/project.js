...
export const projects = [
    ...
    },
    {
      title: "NutrLensAI",
      description:
        "Automated food label image nutrition extraction using EasyOCR and transformer-based models. Built NLP pipeline to classify and extract nutritional data, enabling users to plan diets with personalized recommendations.",
      image: "/images/nutrients.jpg",
      tech: ["AI/ML", "Python", "PyTorch", "OCR", "NLP"],
      github: "https://github.com/aryangoku/NutriLensAI", 
    },
    {
      title: "Buddies",
      description:
